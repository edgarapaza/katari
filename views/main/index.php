	...
	<section class="cuerpo1">
		...
		<div class="grid-x">
			<div class="cell small-12 medium-6 large-4">
				<div class="thumbnail">
					<img src="https://images.pexels.com/photos/3182829/pexels-photo-3182829.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
						alt="Grupo">
				</div>
			</div>
			<div class="cell small-12 medium-6 large-8">
				<p>Servicios como desarrollador de software a medida. Nuestros desarrolladores de software crean
					plataformas adhoc a medida para grandes empresas, pymes y pequeñas empresas.</p>
				<br>
				<p>Nuestro equipo de programadores de software pueden ayudarlo a transformar su negocio con las últimas
					capacidades tecnológicas para mantenerse a la vanguardia. Desarrollo de software confiable y
					escalable para cualquier sistema operativo, navegador y dispositivo.</p>
			</div>
		</div>
	</section>
	...
	<div class="grid-container">
		...
		<div class="grid-x">
			...
			<div class="cell small-12 medium-6 large-4">
				<div class="card">
					<img class="thumbnail"
						src="https://images.pexels.com/photos/2881232/pexels-photo-2881232.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
						alt="Photo of Uranus.">
					<div class="card-section">
		...
		<div class="grid-x">
			<div class="cell small-12 medium-6 large-4">
				<div class="card">
					<img class="thumbnail"
						src="https://images.pexels.com/photos/6334780/pexels-photo-6334780.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
						alt="Photo of Uranus.">
					<div class="card-section">
		...
		<div class="grid-x grid-margin-x">
			<div class="cell small-12 medium-6 large-4">
				<div class="card">
					...
					<div class="card-section">
						<h4>RAPIDO</h4>
						<p>Nuestra experiencia nos permite culminar proyectos en el tiempo requerido con máxima calidad.
						</p>
					</div>
				</div>
			</div>
			<div class="cell small-12 medium-6 large-4">
				<div class="card">
					...
					<div class="card-section">
						<h4>ACCESIBLE</h4>
						<p>Brindamos precios justos y accesibñes, dependiendo de nuestros planes web. Compara nuestros
							precios</p>
					</div>
				</div>
			</div>
			<div class="cell small-12 medium-6 large-4">
				<div class="card">
					...
					<div class="card-section">
						<h4>PROFESIONALES</h4>
						<p>Contamos con personal 100% profesional, capacitado y calificado, expertos en Diseño Web,
							profesionales.</p>
					</div>
				</div>
			</div>
		...
		<div class="grid-container">
			<div class="grid-x grid-padding-y">
				...
				<div class="cell small-12 medium-4 large-3 titulo-footer">
					...
					<a href="https://twitter.com/eapaza15" target="_blank" class="rss"><i
