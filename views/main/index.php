  ...
  <section class="cuerpo1">
    ...
    <div class="grid-x">
      ...
      <div class="cell small-12 medium-6 large-8">
        <p class="p-central">Servicios como desarrollador de software a medida. Nuestros desarrolladores de software crean
          plataformas adhoc a medida para grandes empresas, pymes y pequeñas empresas.</p>
        <br>
        <p class="p-central">Nuestro equipo de programadores de software pueden ayudarlo a transformar su negocio con las últimas
