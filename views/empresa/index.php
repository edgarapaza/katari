  ...
  <div class="grid-x">
    <div class="cell small-12 large-12">
      ...
      <ol>
        ...
        <li><b>KATARI ANALITICS</b>. - Esta se encarga del analisis y modelamiento de datos, haciendo uso de MACHINE LEARNING con el lenguaje R y R Studio. Tambien realizamos analisis estadistico para tesis en SPSS u otras como JAMOVI, etc.</li>
        <li><b>KATARI NETWORK</b>. - Se encarga de proyectos de redes y cableado estructurado para instituciones y domicilios particulares. Pronto se implementarán las instalaciones de camaras de seguridad y cableado con fibra optica.</li>
      </ol>
